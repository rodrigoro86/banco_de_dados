...
class Transacao(SQLModel, table=True):
    ...
    CPFCNPJ_credor: int
    CPFCNPJ_pagador: int
    conta_origem: "Conta" = Relationship(back_populates="transacoes")
    conta_destino: "Conta" = Relationship(back_populates="transacoes")
    movimento: "Movimento" = Relationship(back_populates="transacoes")
    status_transacao: "StatusTransacao" = Relationship(back_populates="transacoes")